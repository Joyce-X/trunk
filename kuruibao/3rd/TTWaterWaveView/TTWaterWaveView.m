...
@property (weak, nonatomic,readwrite) CADisplayLink *displayLink;
@end
...
- (void)startWave {
    ...
    if (_firstWaveLayer == nil) {
        ...
        _firstColorLayer.colors = @[(id)[_firstWaveColor colorWithAlphaComponent:0.3].CGColor, (id)[_firstWaveColor colorWithAlphaComponent:0.0].CGColor];
    ...
    if (_secondWaveLayer == nil) {
        ...
        _secondColorLayer.colors = @[(id)[_secondWaveColor colorWithAlphaComponent:0.2].CGColor, (id)[_secondWaveColor colorWithAlphaComponent:0.1].CGColor];
    ...
    self.displayLink = _waveDisplaylink;
}
