...
//    }
    ...
    if([self.delegate  respondsToSelector:@selector(chinaPickerViewDidClickOK)])
    {
        [_delegate chinaPickerViewDidClickOK];
...
- (void)initPickerView{
    ...
    self.addPickVview.frame = CGRectMake(0,  kScreenHeight-216 - 25, kScreenWidth, 25);
    self.addPickVview.backgroundColor = [UIColor grayColor];
...
//    [self addSubview:titleView];
    ...
    [sureBtn setTitle:JJLocalizedString(@"确定", nil) forState:UIControlStateNormal];
    [sureBtn setTitle:JJLocalizedString(@"确定", nil) forState:UIControlStateHighlighted];
    ...
    pickerView.frame = CGRectMake(0, kScreenHeight-216, kScreenWidth, 216);
